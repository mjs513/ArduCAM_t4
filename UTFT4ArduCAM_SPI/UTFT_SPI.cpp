...
void UTFT::LCD_Write_COM_DATA(char com1,uint16_t dat1)
{
     LCD_Write_COM(com1);
...
void UTFT::drawRect(int16_t x1, int16_t y1, int16_t x2, int16_t y2)
{
	if (x1>x2)
	{
		swap(int16_t, x1, x2);
...
void UTFT::drawRoundRect(int16_t x1, int16_t y1, int16_t x2, int16_t y2)
{
	if (x1>x2)
	{
		swap(int16_t, x1, x2);
...
void UTFT::fillRect(int16_t x1, int16_t y1, int16_t x2, int16_t y2)
{
	if (x1>x2)
	{
		swap(int16_t, x1, x2);
...
void UTFT::fillRoundRect(int16_t x1, int16_t y1, int16_t x2, int16_t y2)
{
	if (x1>x2)
	{
		swap(int16_t, x1, x2);
...
void UTFT::drawCircle(int16_t x, int16_t y, int16_t radius)
{
	int f = 1 - radius;
	int ddF_x = 1;
	int ddF_y = -2 * radius;
...
void UTFT::fillCircle(int16_t x, int16_t y, int16_t radius)
{
...
{
	int16_t color = ((r&248)<<8 | (g&252)<<3 | (b&248)>>3);
	fillScr(color);
}

void UTFT::fillScr(int16_t color)
{
	long i;
	char ch, cl;
...
void UTFT::setColor(int16_t color)
{
	fch=byte(color>>8);
	fcl=byte(color & 0xFF);
}

int16_t UTFT::getColor()
{
	return (fch<<8) | fcl;
}
...
void UTFT::setBackColor(int16_t color)
{
...
int16_t UTFT::getBackColor()
{
	return (bch<<8) | bcl;
}

void UTFT::setPixel(int16_t color)
{
	LCD_Write_DATA((color>>8),(color&0xFF));	// rrrrrggggggbbbbb
}

void UTFT::drawPixel(int16_t x, int16_t y)
{
	setXY(x, y, x, y);
	setPixel((fch<<8)|fcl);
	clrXY();
...
void UTFT::drawLine(int16_t x1, int16_t y1, int16_t x2, int16_t y2)
{
	if (y1==y2)
		drawHLine(x1, y1, x2-x1);
	else if (x1==x2)
...
void UTFT::drawHLine(int16_t x, int16_t y, int16_t l)
{
	if (l<0)
	{
		l = -l;
...
void UTFT::drawVLine(int16_t x, int16_t y, int16_t l)
{
	if (l<0)
	{
		l = -l;
...
void UTFT::printChar(byte c, int16_t x, int16_t y)
{
	byte i,ch;
	word j;
	word temp; 
...
void UTFT::rotateChar(byte c, int16_t x, int16_t y, int16_t pos, int16_t deg)
{
	byte i,j,ch;
	word temp; 
	int newx,newy;
...
void UTFT::print(char *st, int16_t x, int16_t y, int16_t deg)
{
	int stl, i;
...
void UTFT::print(String st, int16_t x, int16_t y, int16_t deg)
{
...
void UTFT::printNumI(long num, int16_t x, int16_t y, int16_t length, char filler)
{
	char buf[25];
	char st[27];
	boolean neg=false;
...
void UTFT::printNumF(double num, byte dec, int16_t x, int16_t y, char divider, int16_t length, char filler)
{
	char st[27];
	boolean neg=false;
...
void UTFT::drawBitmap(int16_t x, int16_t y, int16_t sx, int16_t sy, bitmapdatatype data, int16_t scale)
{
	uint16_t col;
...
void UTFT::drawBitmap(int16_t x, int16_t y, int16_t sx, int16_t sy, bitmapdatatype data, int16_t deg, int16_t rox, int16_t roy)
{
	uint16_t col;
...
void UTFT::_fast_fill_16(int16_t ch, int16_t cl, long pix)
{

}

void UTFT::_fast_fill_8(int16_t ch, long pix)
{
...
void UTFT::_convert_float(char *buf, double num, int16_t width, byte prec)
{
