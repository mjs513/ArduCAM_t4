...
class UTFT
{
	public:
		...
		void	setBackColor(int16_t color);
		...
		void	drawBitmap(int16_t x, int16_t y, int16_t sx, int16_t sy, bitmapdatatype data, int16_t scale=1);
		...
		int bus_write(int16_t address, int16_t value);
		int bus_read(int16_t address);
...
*/
		...
		void setPixel(int16_t color);
		void drawHLine(int16_t x, int16_t y, int16_t l);
		void drawVLine(int16_t x, int16_t y, int16_t l);
		void printChar(byte c, int16_t x, int16_t y);
		void setXY(int16_t x1, int16_t y1, int16_t x2, int16_t y2);
		void clrXY();
		void resetXY();
		void rotateChar(byte c, int16_t x, int16_t y, int16_t pos, int16_t deg);
		void _set_direction_registers(byte mode);
		void _fast_fill_16(int16_t ch, int16_t cl, long pix);
		void _fast_fill_8(int16_t ch, long pix);
		void _convert_float(char *buf, double num, int16_t width, byte prec);
};
